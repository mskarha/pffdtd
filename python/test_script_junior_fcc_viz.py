...
sim_setup(
    model_json_file='../amy/model_export.json',
    ...
    fmax=5000.0,
    save_folder='../data/sim_data/amy/viz',
    compress=0,
    draw_vox=True,
...
#   python3 -m fdtd.sim_fdtd --data_dir='../data/sim_data/junior/viz' --plot --draw_backend='mayavi' --json_model='../junior/model_export.json'
