...
sim_setup(
    model_json_file='../aspenexg/model_export.json',
...
'Wood Ceiling': 'Wood Ceiling.h5',
    ...
    fmax=1000.0,
    save_folder='../data/sim_data/aspenexg/viz',
    compress=0,
    draw_vox=True,
...
#   python3 -m fdtd.sim_fdtd --data_dir='../data/sim_data/aspenexg/viz' --plot --draw_backend='mayavi' --json_model='../aspenexg/model_export.json'
